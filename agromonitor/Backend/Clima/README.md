...
A app já está configurada em `settings.py`, mas você precisa ter a chave da API OpenWeatherMap:

```python
# Em BD_FAZENDA/settings.py
OPENWEATHER_API_KEY = '6c050647f447b001b8568ef818cbdc94'
```
